...
6. **캘린더** — 정책 DB의 실제 `신청기간_정리`를 월간 달력에 표시
7. **기기 캘린더 연동** — 신청 시작/마감 일정을 Android/iOS 시스템 캘린더 생성 화면으로 전달
8. **정책 상세** — 자격 분석 이유, 지원 내용, 신청 기간, 신청 방법, 제출서류, 공식 신청 URL
9. **마이** — AI 프로필 수정, API 서버 주소 변경, PostgreSQL/GPT 연결 상태 확인
10. **로컬 저장** — 온보딩/프로필/API 주소를 AsyncStorage에 저장
